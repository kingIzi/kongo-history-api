...
public class AbstractFirestoreRepository<T> {
    ...
    private String uploadFile(File file, String fileName, String contentType) throws IOException {
        ...
        return String.format(DOWNLOAD_URL, AbstractFirestoreRepository.BUCKET_NAME,
    ...
    // random strinh for destination file name
    // String destFilePath = "Z:\\New folder\\" + destFileName; // to set
    // destination file path

    // //////////////////////////////// Download
    // ////////////////////////////////////////////////////////////////////////
    // Credentials credentials = GoogleCredentials.fromStream(new
    // FileInputStream("path of JSON with genarated private key"));
    // Storage storage =
